...
TSharedPtr< FSlateStyleSet > FAdventurePluginDialogEditorStyle::StyleInstance = NULL;

void FAdventurePluginDialogEditorStyle::Initialize()
{
...
void FAdventurePluginDialogEditorStyle::Shutdown()
{
...
FName FAdventurePluginDialogEditorStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("AdventurePluginDialogEditorStyle"));
	return StyleSetName;
}
...
void FAdventurePluginDialogEditorStyle::ReloadTextures()
{
...
const ISlateStyle& FAdventurePluginDialogEditorStyle::Get()
{
