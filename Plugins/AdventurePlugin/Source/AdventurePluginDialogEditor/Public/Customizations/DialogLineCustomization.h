...
/**
* Property editor customization for UDialogGraphNode_DialogLineBase class, which replaces its AnimationName property
...
public:
	...
	*/
	...
	/**
	* Retrieves the AnimationName property of the customized UDialogGraphNode_DialogLineBase,
