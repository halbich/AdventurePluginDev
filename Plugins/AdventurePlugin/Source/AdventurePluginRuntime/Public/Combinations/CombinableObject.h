...
public:
	...
	/*Returns a combination between this and target object if it exists.*/
	UFUNCTION(BlueprintCallable, Category = "AdventurePlugin|Combinations")
	...
	/* Executes the specified combination. Ensures that source and target objects are set correctly.*/
	UFUNCTION(BlueprintCallable, Category = "AdventurePlugin|Combinations")
